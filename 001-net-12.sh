...
ip link set dev vxlan-10 address 22:a3:cf:13:ec:4a

ip link set dev veth0 up
ip link set dev cni0 up
ip link set dev vxlan-10 up
ip addr add 10.244.2.1/24 broadcast 10.244.2.255 dev cni0
ip addr add 10.244.2.0/32 dev vxlan-10
ip netns add ns1
ip link set veth1 netns ns1
ip netns exec ns1 ip link set dev veth1 mtu 1450
ip netns exec ns1 ip link set dev veth1 address 7e:88:8f:bf:bf:73
ip netns exec ns1 ip link set dev veth1 up
ip netns exec ns1 ip link set dev lo up
ip netns exec ns1 ip addr add 10.244.2.2/24 dev veth1
ip netns exec ns1 ip route add default via 10.244.2.1

ip route add 10.244.1.0/24 dev vxlan-10 via 10.244.1.0 onlink
ip route add 10.244.0.0/24 dev vxlan-10 via 10.244.0.0 onlink

arp -s 10.244.1.0 2a:7b:50:26:9c:b8 -i vxlan-10
arp -s 10.244.0.0 00:4b:d6:7b:d5:8d -i vxlan-10
...
bridge fdb append 00:00:00:00:00:00 dev vxlan-10 dst 192.168.28.10
bridge fdb append 00:8e:6a:c9:a3:0b dev vxlan-10 dst 192.168.28.10