...
ip link set dev vxlan-10 address 2a:7b:50:26:9c:b8

ip link set dev veth0 up
ip link set dev cni0 up
ip link set dev vxlan-10 up
ip addr add 10.244.1.1/24 broadcast 10.244.1.255 dev cni0
ip addr add 10.244.1.0/32 dev vxlan-10
ip netns add ns1
ip link set veth1 netns ns1
ip netns exec ns1 ip link set dev veth1 mtu 1450
ip netns exec ns1 ip link set dev veth1 address b2:cd:05:e0:67:ea
